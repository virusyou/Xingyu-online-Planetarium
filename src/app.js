...
Ammo().then((Ammo) => {
  ...
  function createGridPlane() {
    let pos = { x: 0, y: -0.25, z: 0 };//{ x: 0, y: -0.25, z: 0 };
    let scale = { x: 350, y: 1, z: 350 };  //175 0.5 175
    let quat = { x: 0, y: 0, z: 0, w: 1 };
    let mass = 0;

    var grid = new THREE.GridHelper(175, 20, 0xffffff, 0xffffff);
    grid.material.opacity = 0 ; //0.5
  ...
  function createBeachBall() {
    ...
    var beachTexture = texture_loader.load('./src/jsm/moon.jpeg');
  ...
  function loadRyanText() {
    ...
    text_loader.load('./src/jsm/Poppins_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry("Cosmos", {
        font: font,
        size: 3,
        height: 0.5,
        curveSegments: 12,
  ...
  function loadEngineerText() {
    ...
    text_loader.load('./src/jsm/Poppins_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('is infinite', {
        font: font,
        size: 1.5,
        height: 0.5,
        curveSegments: 20,
  ...
  function createBillboard(
    ...
    const billboardSignScale = { x: 60, y: 30, z: 2 };  //30 15 1
  ...
  function createWallX(x, y, z) {
    const wallScale = { x: 0.125, y: 4, z: 350 }; //0.125,4,175
  ...
  function createWallZ(x, y, z) {
    const wallScale = { x: 350, y: 4, z: 0.125 }; //175,4,0.125
  ...
  function start() {
    ...
    // 这里调整边界
    createWallX(175, 3.5, 0);    // 87.5,1.75,0
    createWallX(-175, 3.5, 0);    //-87.5,1.75,0
    createWallZ(0, 3.5, 175);      //0,1.75,87.5
    createWallZ(0, 3.5, -175);     //0,1.75,-87.5
   ...
   // 第三块展板
    ...
    // // // 浮动文字
    // floatingLabel(-50, 4.5, -30, 'Github');
    ...
    //板块文字
    simpleText(-40, 0.5, 0, 'Satellite Hall', 2);
    createTriangle(-45, -8);
    createTriangle(-45, -12);
    createTriangle(-45, -16);
    createTriangle(-45, -20);

    simpleText(60, 0.5, -35, 'Our home —— Solar System', 2);
    createTriangle(63, -55);
    createTriangle(63, -51);
    createTriangle(63, -47);
    createTriangle(63, -43);

    simpleText(-35, 0.5, -90, 'Interaction Hall', 2);
    createTriangle(-40, -98);
    createTriangle(-40, -106);
    createTriangle(-40, -114);
    createTriangle(-40, -122);

    simpleText(25, 0.5, -100, 'Ancient Astrology Hall', 2);
    createTriangle(28, -108);
    createTriangle(28, -116);
    createTriangle(28, -124);
    createTriangle(28, -132);
